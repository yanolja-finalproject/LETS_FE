...
const ConfirmModal = ({ isOpen, onClose, onConfirm }: Props) => {
  ...
  return (
    ...
    <div className="fixed top-0 left-0 w-full h-full bg-black-6">
      <div className="w-[87.2%] mx-auto absolute top-[30%] left-[50%] translate-x-[-50%] rounded-md bg-white h-[176px] flex flex-col justify-evenly ">
        <p className="text-4.5 font-bold text-center">
          정말로 탈퇴 하시겠어요?
        </p>
